...
The [benchmarks](benchmarks/README.md), [paper](paper/README.md), generated PDFs,
and results figures are historical snapshots from before this hardening. They are
not evidence that the current deployment controls have been tested in production.
